...
version: 1.0.1
description: >-
  Audit and improve how a site is represented to AI search and agents. Use for "audit for AI
  visibility", "optimize for ChatGPT", "check GEO readiness", "analyze hedge density", "generate
  agentfacts", or "test how LLMs describe my site". Ships a runnable auditor and an agentfacts
  schema. For traditional search ranking and schema markup, use ai-seo-optimization.
---
