...
source_path: templates/dpa-us/template.md
source_ref: c7c947f5d65716f1395d58ef7fda6eb2847a29b0
license: CC0-1.0
vendored: 2026-08-20
modifications: "restored section numbering 1-11 and subsection letters lost in docx conversion, completed dropped cross-reference 'this Section' to 'this Section 7' in Subprocessors, corrected Annex 1 subprocessor-list pointer from Annex 5 to Annex 4, numbered State Privacy Laws Annex paragraphs 1-6 to resolve its 'Section 3' self-reference, wrapped WEBSITE and signature-block fill-ins in mark tags, repaired bold headings split across lines and removed stray zero-width characters"
---
...
(b) Processing of Personal Data subject to the State Privacy Laws with respect to which Customer is a Business, Controller, Processor, or Service Provider (as such terms are defined in State Privacy Laws) shall be subject to Annex 2 (State Privacy Laws Annex) to this DPA.
...
(b) Information about Subprocessors. Information about Subprocessors, including their functions and locations, is available in Annex 4 of this DPA/at [<mark>WEBSITE</mark>] (the "Subprocessor Site"). Provider may continue to use those Subprocessors already engaged by Provider as of the effective date of this DPA.
...
(d) The total aggregate liability of either Party to the other Party, however arising, under or in connection with this DPA will under no circumstances exceed any limitations or caps on, and will be subject to any exclusions of, liability and loss agreed by the Parties in the Agreement.
