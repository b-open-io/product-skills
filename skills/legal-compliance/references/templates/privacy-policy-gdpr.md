---
source: General-Legal/legal-templates
source_path: docx-originals/privacy-policy-gdpr-enhanced.docx
source_ref: c7c947f5d65716f1395d58ef7fda6eb2847a29b0
license: CC0-1.0
vendored: 2026-08-20
modifications: "regenerated markdown from docx, unescaped mammoth artifacts, removed Word bookmark anchors, normalized heading hierarchy, replaced broken TOC links with plain headings list, rebuilt CCPA statutory-category and legal-bases charts as markdown tables, restored hyperlinks from docx, re-applied mark tags to fill-in fields per docx highlights, closed unbalanced bracket on Blocking images item, relabeled duplicated 'Events, promotions and contests' legal-bases row to 'Data sharing in the context of corporate events', updated transfers section to acknowledge the EU-U.S. Data Privacy Framework adequacy decision"
---
...
**TEMPLATE PRIVACY POLICY AND COOKIE NOTICE**
...
[<mark>Full Company Name</mark>] [and our subsidiaries and affiliates] ("**[<mark>CompanyName</mark>]**," "**we**", “**us**” or "**our**") provides a [<mark>DESCRIPTION OF BUSINESS</mark>]. This Privacy Policy describes how [<mark>CompanyName</mark>] processes personal information that we collect through our digital or online properties or services that link to this Privacy Policy (including as applicable, our website, mobile application, and social media pages) as well as our marketing activities, live events and other activities described in this Privacy Policy (collectively, the "Service").
...
[<mark>**Delete your content or close your account.** You can choose to delete certain content through your account. If you wish to request to close your account, please contact us.</mark>]
...
| --- | --- | --- |
| Service delivery and operations | Contact data<br>Demographic data<br>Profile data<br>Communications data<br>Transactional data<br>User-generated content and input data<br>Relationship data<br>Payment data<br>Data from Third Party Services<br>Device data | Contractual Necessity |
